...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'pdf_file', type=pathlib.Path, metavar='PDF_FILE', help='PDF file to extract pages from'
    )
    parser.add_argument(
        'output_dir', type=pathlib.Path, metavar='OUTPUT_DIR', help='Directory to output individual pages to'
    )
