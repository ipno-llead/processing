...
def clean20():
    df = (
        pd.read_csv(dirk.data("raw/scott_pd/scott_pd_cprr_2020.csv"))
...
def clean14():
    df = (
        pd.read_csv(dirk.data("raw/scott_pd/scott_pd_cprr_2009_2014.csv"))
        .pipe(clean_column_names)
        .drop(columns=["appeal"])
...
if __name__ == "__main__":
    df20 = clean20()
    df14 = clean14()
    df20.to_csv(dirk.data("clean/cprr_scott_pd_2020.csv"), index=False)
    df14.to_csv(dirk.data("clean/cprr_scott_pd_2009_2014.csv"), index=False)
