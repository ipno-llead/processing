...
def clean_17():
    df = pd.read_csv(
        dirk.data("raw/baton_rouge_csd/baton_rouge_csd_pprr_2017.csv")
...
def clean_19():
    df = pd.read_csv(
        dirk.data("raw/baton_rouge_csd/baton_rouge_csd_pprr_2019.csv")
    ).pipe(clean_column_names)
...
if __name__ == "__main__":
    ...
    df17.to_csv(dirk.data("clean/pprr_baton_rouge_csd_2017.csv"), index=False)
    df19.to_csv(dirk.data("clean/pprr_baton_rouge_csd_2019.csv"), index=False)
