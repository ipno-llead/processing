...
def clean():
    return (
        pd.read_csv(dirk.data("raw/kenner_pd/kenner_pd_pprr_2020.csv"))
...
def clean_former_long():
    return (
        pd.read_csv(dirk.data("raw/kenner_pd/kenner_pd_pprr_formeremployees_long.csv"))
        .pipe(clean_column_names)
        .rename(
            columns={
                "title": "rank_desc",
...
def clean_former_short():
    return (
        pd.read_csv(dirk.data("raw/kenner_pd/kenner_pd_pprr_formeremployees_short.csv"))
        .pipe(clean_column_names)
        .rename(
            columns={
                "date_hired": "hire_date",
...
if __name__ == "__main__":
    ...
    combined.to_csv(dirk.data("clean/pprr_kenner_pd_2020.csv"), index=False)
