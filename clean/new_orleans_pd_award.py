...
def clean():
    df = pd.read_csv(dirk.data("raw/ipm/new_orleans_pd_commendations_2016_2021.csv"))
    df = (
...
if __name__ == "__main__":
    ...
    award.to_csv(dirk.data("clean/award_new_orleans_pd_2016_2021.csv"), index=False)
