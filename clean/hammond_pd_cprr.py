...
def clean_14():
    df = pd.read_csv(deba.data("raw/hammond_pd/hammond_pd_cprr_2009_2014.csv"))
    df = (
...
def clean_08():
    df = (
        pd.read_csv(deba.data("raw/hammond_pd/hammond_pd_cprr_2004_2008.csv"))
...
if __name__ == "__main__":
    ...
    df14 = clean_14()
    df08 = clean_08()
    df20.to_csv(deba.data("clean/cprr_hammond_pd_2015_2020.csv"), index=False)
    df14.to_csv(deba.data("clean/cprr_hammond_pd_2009_2014.csv"), index=False)
    df08.to_csv(deba.data("clean/cprr_hammond_pd_2004_2008.csv"), index=False)
