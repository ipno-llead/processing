...
def remove_current_dates(df):
    df.loc[:, 'termination_date'] = df.termination_date.str.lower().str.strip()\
...
def clean():
    return pd.read_csv(data_file_path(
        'raw/sterlington_pd/sterlington_csd_ppprr_2010_2020.csv'
...
if __name__ == '__main__':
    ...
    df.to_csv(data_file_path(
        'clean/pprr_sterlington_csd_2010_2020.csv'
    ), index=False)
