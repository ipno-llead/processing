...
def clean21():
    df = (
        pd.read_csv(dirk.data("raw/houma_pd/houma_pd_cprr_2019_2021.csv"))
...
def clean18():
    df = (
        pd.read_csv(dirk.data("raw/houma_pd/houma_pd_cprr_2017_2018.csv"))
        .pipe(clean_column_names)
...
if __name__ == "__main__":
    df21 = clean21()
    df18 = clean18()
    df21.to_csv(dirk.data("clean/cprr_houma_pd_2019_2021.csv"), index=False)
    df18.to_csv(dirk.data("clean/cprr_houma_pd_2017_2018.csv"), index=False)
