...
def clean19():
    df = pd.read_csv(dirk.data("raw/plaquemines_so/plaquemines_so_cprr_2019.csv"))
...
def clean20():
    df = (
        pd.read_csv(dirk.data("raw/plaquemines_so/plaquemines_so_cprr_2016_2020.csv"))
...
if __name__ == "__main__":
    df19 = clean19()
    df20 = clean20()
    df19.to_csv(dirk.data("clean/cprr_plaquemines_so_2019.csv"), index=False)
    df20.to_csv(dirk.data("clean/cprr_plaquemines_so_2016_2020.csv"), index=False)
