...
def clean_codebook():
    df = pd.read_csv(
        dirk.data("raw/shreveport_pd/shreveport_codebook.csv"),
        names=["name", "code"],
    )
...
if __name__ == "__main__":
    df = pd.concat(
        [
            clean_cprr(
                ...
                pd.read_csv(
                    dirk.data("raw/shreveport_pd/shreveport_pd_cprr_names_2018.csv")
                ),
                "2018",
            ),
            clean_cprr(
                ...
                pd.read_csv(
                    dirk.data("raw/shreveport_pd/shreveport_pd_cprr_names_2019.csv")
                ),
                "2019",
            ),
        ]
    ...
    df.to_csv(dirk.data("clean/cprr_shreveport_pd_2018_2019.csv"), index=False)
    cb_df.to_csv(dirk.data("clean/cprr_codebook_shreveport_pd.csv"), index=False)
