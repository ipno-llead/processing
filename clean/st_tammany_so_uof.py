...
def clean_citizen_condition(df):
    if "citizen_condition" in df.columns:
...
def clean_2022_2024():
    df = (
        pd.read_csv(deba.data("raw/st_tammany_so/stpso_uof_2022_2024.csv"), low_memory=False)
        ...
        .rename(columns={
            ...
            "empsnp_last_name": "last_name",
            "emp_first_name": "first_name",
        })
        .drop(columns=["emp_payroll", "citsnp_age"], errors="ignore")
        .drop_duplicates()
...
if __name__ == "__main__":
    # Clean 2022-2024 data
    uof_2022_2024, citizen_uof_2022_2024 = clean_2022_2024()
    uof_2022_2024.to_csv(deba.data("clean/uof_st_tammany_so_2022_2024.csv"), index=False)
    citizen_uof_2022_2024.to_csv(deba.data("clean/uof_cit_st_tammany_so_2022_2024.csv"), index=False)

    # Clean 2025 data
    uof_2025, citizen_uof_2025 = clean25()
    uof_2025.to_csv(deba.data("clean/uof_st_tammany_so_2025.csv"), index=False)
    citizen_uof_2025.to_csv(deba.data("clean/uof_cit_st_tammany_so_2025.csv"), index=False)
