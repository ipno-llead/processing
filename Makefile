...
all: data/fuse/event_harahan_pd.csv data/fuse/per_harahan_pd.csv
...
data/fuse/event_harahan_pd.csv data/fuse/per_harahan_pd.csv: fuse/harahan_pd.py data/match/pprr_harahan_pd_2020.csv data/clean/pprr_harahan_csd_2020.csv data/match/post_event_harahan_pd.csv
	python fuse/harahan_pd.py
...
data/match/pprr_harahan_pd_2020.csv data/match/post_event_harahan_pd.csv: match/harahan_pd.py data/clean/pprr_harahan_pd_2020.csv data/clean/pprr_harahan_csd_2020.csv data/clean/pprr_post_2020_11_06.csv
	python match/harahan_pd.py
