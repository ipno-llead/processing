...
def match_pd_cprr_v_pprr(cprr, pprr):
    dfa = (
        cprr[["first_name", "last_name", "middle_name", "uid"]]
        .drop_duplicates("uid")
        .set_index("uid", drop=True)
...
if __name__ == "__main__":
    ...
    cprr = pd.read_csv(deba.data("clean/cprr_baton_rouge_pd_2004_2023.csv"))
    ...
    cprr = match_pd_cprr_v_pprr(cprr, pprr)
    ...
    cprr.to_csv(deba.data("match/cprr_baton_rouge_pd_2004_2023.csv"), index=False)
