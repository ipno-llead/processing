...
def assign_uid_from_post(cprr, post):
    ...
    matcher.save_pairs_to_excel(
        data_file_path(
            "match/cprr_denham_springs_pd_2016_2021_v_post_pprr_2020_11_06.xlsx"
        ),
        decision,
    )
...
if __name__ == "__main__":
    ...
    post = post[post.agency == "denham springs pd"]
    cprr = assign_uid_from_post(cprr, post)
    cprr.to_csv(
        data_file_path("match/cprr_denham_springs_pd_2016_2021.csv"), index=False
    )
