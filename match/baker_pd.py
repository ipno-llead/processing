...
def match_uof_and_pprr(uof, pprr):
    ...
    decision = .94
    matcher.save_pairs_to_excel(
        deba.data("match/uof_baker_pd_2021_2025_v_pprr_baker_pd_2010_2020.xlsx"),
        decision,
    )
    matches = matcher.get_index_pairs_within_thresholds(decision)
    match_dict = dict(matches)
...
if __name__ == "__main__":
    ...
    uof = pd.read_csv(deba.data("clean/uof_baker_pd_2021_2025.csv"))
    ...
    uof.to_csv(deba.data("match/uof_baker_pd_2021_2025.csv"), index=False)
