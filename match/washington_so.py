...
def assign_uid_from_post(cprr, post):
    ...
    matcher.save_pairs_to_excel(data_file_path(
        "match/cprr_washington_so_2015_2020_v_post_pprr_2020_11_06.xlsx"), decision)
...
if __name__ == '__main__':
    ...
    post = post[post.agency == 'Washington SO']
    cprr = assign_uid_from_post(cprr, post)
    cprr.to_csv(data_file_path(
        'match/cprr_washington_so_2015_2020.csv'), index=False)
