...
def match_cprr_and_post(cprr, post):
    ...
    decision = 0.90
    matcher.save_pairs_to_excel(
        deba.data("match/cprr_gretna_2020_2025_v_post_pprr_08_25_2025.xlsx"),
        decision,
    )
    matches = matcher.get_index_pairs_within_thresholds(decision)
    match_dict = dict(matches)
...
if __name__ == "__main__":
    ...
    cprr = pd.read_csv(deba.data("clean/cprr_gretna_pd_2020_2025.csv"))
    ...
    cprr.to_csv(deba.data("match/cprr_gretna_pd_2020_2025.csv"), index=False)
