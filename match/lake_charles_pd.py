...
def match_uof_and_post(uof, post):
    ...
    decision = 0.95
    matcher.save_pairs_to_excel(
        deba.data("match/lake_charles_uof_2020_vs_post_2020_11_06.xlsx"), decision
    )
    matches = matcher.get_index_pairs_within_thresholds(decision)
    match_dict = dict(matches)
...
if __name__ == "__main__":
    ...
    uof = pd.read_csv(deba.data("clean/uof_lake_charles_pd_2020.csv"))
    ...
    uof.to_csv(deba.data("match/uof_lake_charles_pd_2020.csv"), index=False)
