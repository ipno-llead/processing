...
def assign_uid_from_post(cprr, post):
    ...
    matcher.save_pairs_to_excel(
        deba.data("match/cprr_west_feliciana_so_2010_2021_v_post_pprr_2020_11_06.xlsx"),
        decision,
    )
...
if __name__ == "__main__":
    ...
    cprr.to_csv(deba.data("match/cprr_west_feliciana_so_2010_2021.csv"), index=False)
