...
def process_pdfs_2023_rotated() -> pd.DataFrame:
    dir_name = real_dir_path("raw_post_officer_history_reports_2023_rotated.dvc")
    return (
        pd.read_csv(deba.data("meta/post_officer_history_reports_2023_rotated_files.csv"))
        .pipe(only_pdf)
...
if __name__ == "__main__":
    ...
    df23_rotated.to_csv(deba.data("ocr/post_officer_history_reports_2023_rotated_pdfs.csv"), index=False)