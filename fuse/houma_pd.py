...
if __name__ == "__main__":
    ...
    event_df.to_csv(deba.data("fuse/event_houma_pd.csv"))
    personnel_df.to_csv(deba.data("fuse/per_houma_pd.csv"))
    allegation_df.to_csv(deba.data("fuse/com_houma_pd.csv"))
