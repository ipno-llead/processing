...
if __name__ == "__main__":
    cprr21 = pd.read_csv(bolo.data("match/cprr_houma_pd_2019_2021.csv"))
    cprr18 = pd.read_csv(bolo.data("match/cprr_houma_pd_2017_2018.csv"))
    ...
    event_df.to_csv(bolo.data("fuse/event_houma_pd.csv"))
    personnel_df.to_csv(bolo.data("fuse/per_houma_pd.csv"))
    allegation_df.to_csv(bolo.data("fuse/com_houma_pd.csv"))
