...
if __name__ == "__main__":
    ...
    event_df.to_csv(deba.data("fuse/event_hammond_pd.csv"))
    personnel_df.to_csv(deba.data("fuse/per_hammond_pd.csv"))
    complaints_df.to_csv(deba.data("fuse/com_hammond_pd.csv"))
