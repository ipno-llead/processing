    ...
    return rearrange_personnel_columns(
        pd.concat(
            [
                ...
                pd.read_csv(deba.data("fuse/personnel_natchitoches_so.csv"))
            ]
        )
    ...
    return rearrange_event_columns(
        pd.concat(
            [
                ...
                pd.read_csv(deba.data("fuse/events_natchitoches_so.csv"))
            ]
        )
    ...
    return rearrange_allegation_columns(
        pd.concat(
            [
                ...
                pd.read_csv(deba.data("fuse/complaints_natchitoches_so.csv"))
            ]
        )
