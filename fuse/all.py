    ...
    return rearrange_personnel_columns(
        pd.concat(
            [
                ...
                pd.read_csv(data_file_path("fuse/per_thibodaux_pd.csv")),
            ]
        )
    ...
    return rearrange_event_columns(
        pd.concat(
            [
                ...
                pd.read_csv(data_file_path("fuse/event_thibodaux_pd.csv")),
            ]
        )
    ...
    return rearrange_allegation_columns(
        pd.concat(
            [
                ...
                pd.read_csv(data_file_path("fuse/com_thibodaux_pd.csv")),
            ]
        )
