...
if __name__ == "__main__":
    cprr19 = pd.read_csv(data_file_path("match/cprr_port_allen_pd_2019.csv"))
    cprr18 = pd.read_csv(data_file_path("match/cprr_port_allen_pd_2017_2018.csv"))
    cprr16 = pd.read_csv(data_file_path("match/cprr_port_allen_pd_2015_2016.csv"))
    post_event = pd.read_csv(data_file_path("match/post_event_port_allen_pd.csv"))
    ...
    personnel_df.to_csv(data_file_path("fuse/per_port_allen_pd.csv"), index=False)
    events_df.to_csv(data_file_path("fuse/event_port_allen_pd.csv"), index=False)
    complaint_df.to_csv(data_file_path("fuse/com_port_allen_pd.csv"), index=False)
