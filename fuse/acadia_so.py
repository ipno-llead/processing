...
if __name__ == "__main__":
    ...
    complaints.to_csv(deba.data("fuse/com_acadia_so.csv"), index=False)
    per.to_csv(deba.data("fuse/per_acadia_so.csv"), index=False)
    event.to_csv(deba.data("fuse/event_acadia_so.csv"), index=False)
