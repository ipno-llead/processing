...
if __name__ == "__main__":
    ...
    personnel_df.to_csv(dirk.data("fuse/per_lafayette_so.csv"), index=False)
    event.to_csv(dirk.data("fuse/event_lafayette_so.csv"), index=False)
    complaints.to_csv(dirk.data("fuse/com_lafayette_so.csv"), index=False)
