...
if __name__ == "__main__":
    ...
    post_event = pd.read_csv(dirk.data("match/post_event_grand_isle_pd.csv"))
    ...
    rearrange_personnel_columns(pprr).to_csv(
        dirk.data("fuse/per_grand_isle_pd.csv"), index=False
    )
    events_df.to_csv(dirk.data("fuse/event_grand_isle_pd.csv"), index=False)
