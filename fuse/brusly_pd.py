...
if __name__ == "__main__":
    ...
    post_event = pd.read_csv(dirk.data("match/post_event_brusly_pd_2020.csv"))
    cprr = pd.read_csv(dirk.data("match/cprr_brusly_pd_2020.csv"))
    award = pd.read_csv(dirk.data("match/award_brusly_pd_2021.csv"))
    cprr = gen_uid(
    ...
    rearrange_personnel_columns(pprr).to_csv(
        dirk.data("fuse/per_brusly_pd.csv"), index=False
    )
    events_df.to_csv(dirk.data("fuse/event_brusly_pd.csv"), index=False)
    com_df.to_csv(dirk.data("fuse/com_brusly_pd.csv"), index=False)
