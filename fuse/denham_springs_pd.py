...
if __name__ == "__main__":
    ...
    event.to_csv(deba.data("fuse/event_denham_springs_pd.csv"), index=False)
    com.to_csv(deba.data("fuse/com_denham_springs_pd.csv"), index=False)
    per.to_csv(deba.data("fuse/per_denham_springs_pd.csv"), index=False)
