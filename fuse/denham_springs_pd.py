...
if __name__ == "__main__":
    ...
    event.to_csv(data_file_path("fuse/event_denham_springs_pd.csv"), index=False)
    com.to_csv(data_file_path("fuse/com_denham_springs_pd.csv"), index=False)
    per.to_csv(data_file_path("fuse/per_denham_springs_pd.csv"), index=False)
