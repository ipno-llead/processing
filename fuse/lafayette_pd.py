...
if __name__ == "__main__":
    cprr_20 = pd.read_csv(data_file_path("match/cprr_lafayette_pd_2015_2020.csv"))
    cprr_14 = pd.read_csv(data_file_path("match/cprr_lafayette_pd_2009_2014.csv"))
    pprr = pd.read_csv(data_file_path("clean/pprr_lafayette_pd_2010_2021.csv"))
    post_events = pd.read_csv(data_file_path("match/post_event_lafayette_pd_2020.csv"))
    ...
    per.to_csv(data_file_path("fuse/per_lafayette_pd.csv"), index=False)
    com.to_csv(data_file_path("fuse/com_lafayette_pd.csv"), index=False)
    events_df.to_csv(data_file_path("fuse/event_lafayette_pd.csv"), index=False)
