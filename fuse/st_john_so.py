...
if __name__ == "__main__":
    ...
    event_df.to_csv(deba.data("fuse/event_st_john_so.csv"), index=False)
    com_df.to_csv(deba.data("fuse/com_st_john_so.csv"), index=False)
    per_df.to_csv(deba.data("fuse/per_st_john_so.csv"), index=False)
