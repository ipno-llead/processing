...
if __name__ == "__main__":
    ...
    per.to_csv(deba.data("fuse/per_iberia_so.csv"), index=False)
    com.to_csv(deba.data("fuse/com_iberia_so.csv"), index=False)
    event.to_csv(deba.data("fuse/event_iberia_so.csv"), index=False)
