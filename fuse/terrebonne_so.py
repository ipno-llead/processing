...
def prepare_post_data():
    ...
    return post[post.agency == 'Terrebonne SO']
...
if __name__ == '__main__':
    ...
    event.to_csv(
        data_file_path('fuse/event_terrebonne_so.csv'), index=False)
    com.to_csv(
        data_file_path('fuse/com_terrebonne_so.csv'), index=False)
    per.to_csv(
        data_file_path('fuse/per_terrebonne_so.csv'), index=False)
