...
if __name__ == "__main__":
    post_event = pd.read_csv(dirk.data("match/post_event_covington_pd_2020.csv"))
    ...
    events_df.to_csv(dirk.data("fuse/event_covington_pd.csv"), index=False)
    fuse_personnel(ah, pprr).to_csv(dirk.data("fuse/per_covington_pd.csv"), index=False)
