...
def prepare_post_data():
    ...
    return post[post.agency == "washington  parish so"]
...
if __name__ == "__main__":
    ...
    event.to_csv(data_file_path("fuse/event_washington_so.csv"), index=False)
    com.to_csv(data_file_path("fuse/com_washington_so.csv"), index=False)
    per.to_csv(data_file_path("fuse/per_washington_so.csv"), index=False)
