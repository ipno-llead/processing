...
if __name__ == "__main__":
    cprr = pd.read_csv(dirk.data("match/cprr_madisonville_pd_2010_2020.csv"))
    pprr = pd.read_csv(dirk.data("clean/pprr_madisonville_csd_2019.csv"))
    pprr.loc[:, "agency"] = "Madisonville PD"
    post_event = pd.read_csv(dirk.data("match/post_event_madisonville_csd_2019.csv"))
    ...
    per.to_csv(dirk.data("fuse/per_madisonville_pd.csv"), index=False)
    event.to_csv(dirk.data("fuse/event_madisonville_pd.csv"), index=False)
    com.to_csv(dirk.data("fuse/com_madisonville_pd.csv"), index=False)
