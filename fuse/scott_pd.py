...
if __name__ == "__main__":
    cprr20 = pd.read_csv(data_file_path("match/cprr_scott_pd_2020.csv"))
    cprr14 = pd.read_csv(data_file_path("match/cprr_scott_pd_2009_2014.csv"))
    pprr = pd.read_csv(data_file_path("clean/pprr_scott_pd_2021.csv"))
    post_event = pd.read_csv(data_file_path("match/post_event_scott_pd_2021.csv"))
    ...
    personnels.to_csv(data_file_path("fuse/per_scott_pd.csv"), index=False)
    events_df.to_csv(data_file_path("fuse/event_scott_pd.csv"), index=False)
    complaints.to_csv(data_file_path("fuse/com_scott_pd.csv"), index=False)
