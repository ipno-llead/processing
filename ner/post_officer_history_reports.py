...
def read_pdfs_22a():
    pdfs = pd.read_csv(deba.data("ocr/post_officer_history_reports_1_26_2023_pdfs.csv"))
    return pdfs
...
if __name__ == "__main__":
    ...
    ner_22a = apply_spacy_model(pdfs_22a, ner)
    # ner_22b = apply_spacy_model(pdfs_22b, ner)
    ner_advocate = apply_spacy_model(pdfs_advocate, ner)
    ner_21.to_csv(deba.data("ner/post_officer_history_reports.csv"), index=False)
    ner_22a.to_csv(deba.data("ner/post_officer_history_reports_1_26_2023.csv"), index=False)
