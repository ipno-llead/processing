...
if __name__ == "__main__":
    ...
    per_df.to_csv(deba.data("fuse_agency/per_west_monroe_pd.csv"), index=False)
    com_df.to_csv(deba.data("fuse_agency/com_west_monroe_pd.csv"), index=False)
    events_df.to_csv(deba.data("fuse_agency/event_west_monroe_pd.csv"), index=False)
    post.to_csv(deba.data("fuse_agency/post_west_monroe_pd.csv"), index=False)
