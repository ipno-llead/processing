...
if __name__ == "__main__":
    ...
    event.to_csv(deba.data("fuse_agency/event_ascension_so.csv"), index=False)
    com.to_csv(deba.data("fuse_agency/com_ascension_so.csv"), index=False)
    per.to_csv(deba.data("fuse_agency/per_ascension_so.csv"), index=False)
