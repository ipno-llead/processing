...
if __name__ == "__main__":
    ...
    per.to_csv(deba.data("fuse_agency/per_madisonville_pd.csv"), index=False)
    event.to_csv(deba.data("fuse_agency/event_madisonville_pd.csv"), index=False)
    com.to_csv(deba.data("fuse_agency/com_madisonville_pd.csv"), index=False)
    post.to_csv(deba.data("fuse_agency/post_madisonville_pd.csv"), index=False)
