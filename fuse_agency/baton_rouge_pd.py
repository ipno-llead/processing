...
def fuse_events(csd_pprr_17, csd_pprr_19, cprr_18, cprr_21, cprr_09, cprr_25, settlements):
...
if __name__ == "__main__":
    ...
    cprr_25 = pd.read_csv(deba.data("match/cprr_baton_rouge_pd_2021_2025.csv"))
