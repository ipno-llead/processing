...
if __name__ == "__main__":
    ...
    events_df.to_csv(deba.data("fuse_agency/event_mandeville_pd.csv"), index=False)
    com_df.to_csv(deba.data("fuse_agency/com_mandeville_pd.csv"), index=False)
    per_df.to_csv(deba.data("fuse_agency/per_mandeville_pd.csv"), index=False)
    post.to_csv(deba.data("fuse_agency/post_mandeville_pd.csv"), index=False)
