...
if __name__ == "__main__":
    ...
    event_df.to_csv(deba.data("fuse_agency/event_st_landry_so.csv"), index=False)
    com_df.to_csv(deba.data("fuse_agency/com_st_landry_so.csv"), index=False)
    per_df.to_csv(deba.data("fuse_agency/per_st_landry_so.csv"), index=False)
