...
if __name__ == "__main__":
    ...
    event_df.to_csv(deba.data("fuse_agency/event_morehouse_so.csv"), index=False)
    com_df.to_csv(deba.data("fuse_agency/com_morehouse_so.csv"), index=False)
    per_df.to_csv(deba.data("fuse_agency/per_morehouse_so.csv"), index=False)
