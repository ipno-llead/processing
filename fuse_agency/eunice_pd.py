...
if __name__ == "__main__":
    ...
    complaints.to_csv(deba.data("fuse_agency/com_eunice_pd.csv"), index=False)
    per.to_csv(deba.data("fuse_agency/per_eunice_pd.csv"), index=False)
    event.to_csv(deba.data("fuse_agency/event_eunice_pd.csv"), index=False)
