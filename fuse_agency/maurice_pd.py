...
if __name__ == "__main__":
    ...
    event.to_csv(deba.data("fuse_agency/event_maurice_pd.csv"), index=False)
    com.to_csv(deba.data("fuse_agency/com_maurice_pd.csv"), index=False)
    per.to_csv(deba.data("fuse_agency/per_maurice_pd.csv"), index=False)
