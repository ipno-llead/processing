...
if __name__ == "__main__":
    ...
    per_df.to_csv(deba.data("fuse_agency/per_brusly_pd.csv"), index=False)
    events_df.to_csv(deba.data("fuse_agency/event_brusly_pd.csv"), index=False)
    com_df.to_csv(deba.data("fuse_agency/com_brusly_pd.csv"), index=False)
    post.to_csv(deba.data("fuse_agency/post_brusly_pd.csv"), index=False)
