...
if __name__ == "__main__":
    ...
    event.to_csv(deba.data("fuse_agency/event_cameron_so.csv"), index=False)
    com.to_csv(deba.data("fuse_agency/com_cameron_so.csv"), index=False)
    per.to_csv(deba.data("fuse_agency/per_cameron_so.csv"), index=False)
