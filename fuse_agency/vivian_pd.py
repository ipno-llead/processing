...
if __name__ == "__main__":
    ...
    per_df.to_csv(deba.data("fuse_agency/per_vivian_pd.csv"), index=False)
    events_df.to_csv(deba.data("fuse_agency/event_vivian_pd.csv"), index=False)
    post.to_csv(deba.data("fuse_agency/post_vivian_pd.csv"), index=False)
