...
if __name__ == "__main__":
    ...
    per_df.to_csv(deba.data("fuse_agency/per_caddo_so.csv"), index=False)
    event_df.to_csv(deba.data("fuse_agency/event_caddo_so.csv"), index=False)
    post.to_csv(deba.data("fuse_agency/post_caddo_so.csv"), index=False)
