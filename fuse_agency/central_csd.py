...
if __name__ == "__main__":
    ...
    per_df.to_csv(deba.data("fuse_agency/per_central_csd.csv"), index=False)
    events_df.to_csv(deba.data("fuse_agency/event_central_csd.csv"), index=False)
    post.to_csv(deba.data("fuse_agency/post_central_csd.csv"), index=False)
